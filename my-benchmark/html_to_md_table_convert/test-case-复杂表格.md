...
| 参数 |  |  |  |  |  |  |
| 参数名 | 传输方向 |  |  | 参数类型 | 参数意义 |  |
| inoldmachineid | IN |  |  | Char* | 12个十六进制F |  |
...
| 参数 |  |  |  |  |  |  |
| 参数名 | 传输方向 |  |  | 参数类型 | 参数意义 |  |
| inoldmachineid | IN |  |  | char * | 读卡器机器ID |  |
| cmdtext | IN |  |  | char * | 开关状态 |  |
| 返回值 |  |  |  |  |  |  |
| 返回类型 |  |  | 返回值 |  |  |  |
| int |  |  | 1 |  |  |  |
| -1 |  |  |  |  | 命令失败 |  |
...
| 参数 |  |  |  |  |  |  |
| 参数名 | 传输方向 |  |  | 参数类型 | 参数意义 |  |
| inmachineid | IN |  |  | char * | 读卡器机器ID |  |
| cmdtext | IN |  |  | char * | 继电器开关 |  |
| 返回值 |  |  |  |  |  |  |
| 返回类型 |  |  | 返回值 |  |  |  |
| int |  |  | 1 |  |  |  |
| -1 |  |  |  |  | 命令失败 |  |
